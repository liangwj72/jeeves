...
public class HttpRestConfig {
    ...
    public RestTemplate restTemplate() {
        ...
        httpContext.setAttribute(HttpClientContext.COOKIE_STORE, cookieStore); // 使用 cookieStore 记录cookie
        ...
        rest.getInterceptors().add(new ClientHttpRequestInterceptor(){
            ...
            public ClientHttpResponse intercept(HttpRequest request, byte[] body, ClientHttpRequestExecution execution) throws IOException {
    			...
    			headers.set("client-version", UOS_PATCH_CLIENT_VERSION);
    			headers.set("extspam", UOS_PATCH_EXTSPAM);
